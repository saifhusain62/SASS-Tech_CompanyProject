  ...
  return (
    <section id="digital-marketing-section" className="relative py-24 lg:py-32 bg-black overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
            ...
            >
              ...
              >
                ...
                <div className="my-8 text-center">
                  ...
                  <div className="text-gray-500 text-sm mt-2">Billed monthly</div>
                </div>
        ...
        >
          {[
            { value: "500+", label: "Campaigns Launched", icon: FaRocket },
            { value: "10M+", label: "Leads Generated", icon: FaUsers },
            { value: "300%", label: "Avg. ROI Increase", icon: FaChartLine },
            { value: "98%", label: "Client Satisfaction", icon: FaGem },
          ].map((stat, idx) => (
            <motion.div
              key={idx}
